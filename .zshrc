...
# export PATH="/Users/shuang/anaconda3/bin:$PATH"  # commented out by conda initialize
...
__conda_setup="$('/Users/shuang/anaconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/Users/shuang/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/Users/shuang/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/Users/shuang/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
...
export PATH="/Users/shuang/.nvm/versions/node/v20.15.0/bin:$PATH"
export PATH="/Users/shuang/Hands-On/heroku/bin:$PATH"

alias pls='pwd && echo "\nCurrent directory:" && ls -lh && echo "\nParent directory (showing first 10 of many):" && (ls -lh .. | head -n 11)'
